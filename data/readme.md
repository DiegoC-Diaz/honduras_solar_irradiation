...
This data package contains the data that powers the chart ["Electricity production by source"](https://ourworldindata.org/grapher/electricity-prod-source-stacked?country=~HND&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website.
